...
def build_and_run(code, lang):
    ...
    # write code into local file and map to the docker
    source_file_parent_dir_name = uuid.uuid4()  # folder name unique
...
def make_dir(dir):
    try:
        os.mkdir(dir)
        print " Tmep build directory [%s] created." % dir
    except OSError:
